...
namespace ChoriRey.Services.WebAPIRest.Controllers.API
{
    ...
    {
        private readonly IProductosApplication _Application;
        private readonly AppSettings _appSettings;

        public ProductosController(IProductosApplication _Application,
        ...
        {
            Response<IEnumerable<ProductosDTO>> response = new Response<IEnumerable<ProductosDTO>>();
        ...
        [HttpPost]
        public async Task<IActionResult> InsertAsync([FromBody] ProductosDTO modelDto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateAsync([FromBody] ProductosDTO modelDto)
        {
            Response<bool> response = new Response<bool>();
        ...
        {
            Response<ProductosDTO> response = new Response<ProductosDTO>();
